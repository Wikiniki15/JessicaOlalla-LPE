...
namespace JessicaOlalla_LPE.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEquipo,NomEquipo,CiuEquipo,Titulos,AcepExtr")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEquipo,NomEquipo,CiuEquipo,Titulos,AcepExtr")] Equipo equipo)
        {
