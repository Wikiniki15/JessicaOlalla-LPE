...
namespace JessicaOlalla_LPE.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(EquipoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var estadio = await _context.Estadio
                .FirstOrDefaultAsync(m => m.Id_Estadio == id);
            if (estadio == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id_Estadio,Nombre_Estadio,Direccion,Ciudad_Estadio,Capacidad")] Estadio estadio)
        {
        ...
        {
            return _context.Estadio.Any(e => e.Id_Estadio == id);
        }
    }
}
